...
class PayPalAPI:
    ...
    def __init__(self):
        # Load credentials from Django settings (which loads from environment)
        ...
        if not self.client_id or not self.client_secret:
            ...
            logger.error("PayPal credentials are empty. Please check your environment variables.")
    ...
    def _are_placeholder_credentials(self):
        """Check if credentials are obviously placeholder/example values"""
        ...
        return (
            self.client_id in placeholder_patterns or
